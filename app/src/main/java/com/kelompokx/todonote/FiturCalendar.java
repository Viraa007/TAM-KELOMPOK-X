...
import com.kelompokx.todonote.home.DatabaseHelper;
import com.kelompokx.todonote.home.ItemAdapter;
import com.kelompokx.todonote.home.ModelData;
...
public class FiturCalendar extends AppCompatActivity {

    public static final String NOTIFICATION_CHANNEL_ID = "10001";
    private final static String default_notification_channel_id = "default";
    private static final String TAG = "FiturCalendar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fitur_calendar);
        getSupportActionBar();
    ...
    private Notification getNotification(String content) {
        ...
        Intent intent = new Intent(this, FiturCalendar.class);
